...
/// Function validator.
pub struct DefaultValidator<E: UserError> {
...
pub trait Validator<E> where E: UserError {
	fn validate_function(context: &mut FunctionValidationContext<E>, block_type: BlockType, body: &[Opcode]) -> Result<(), Error<E>> {
		context.push_label(BlockFrameType::Function, block_type)?;
		Self::validate_function_block(context, body)?;
	...
	fn validate_function_block(context: &mut FunctionValidationContext<E>, body: &[Opcode]) -> Result<(), Error<E>> {
		...
		loop {
			...
			match Self::validate_instruction(context, opcode)? {
	...
	fn validate_instruction(context: &mut FunctionValidationContext<E>, opcode: &Opcode) -> Result<InstructionOutcome, Error<E>> {
		...
		match opcode {
			...
			&Opcode::Block(block_type) => Self::validate_block(context, block_type),
			&Opcode::Loop(block_type) => Self::validate_loop(context, block_type),
			&Opcode::If(block_type) => Self::validate_if(context, block_type),
			&Opcode::Else => Self::validate_else(context),
			&Opcode::End => Self::validate_end(context),
			&Opcode::Br(idx) => Self::validate_br(context, idx),
			&Opcode::BrIf(idx) => Self::validate_br_if(context, idx),
			&Opcode::BrTable(ref table, default) => Self::validate_br_table(context, table, default),
			&Opcode::Return => Self::validate_return(context),

			&Opcode::Call(index) => Self::validate_call(context, index),
			&Opcode::CallIndirect(index, _reserved) => Self::validate_call_indirect(context, index),

			&Opcode::Drop => Self::validate_drop(context),
			&Opcode::Select => Self::validate_select(context),

			&Opcode::GetLocal(index) => Self::validate_get_local(context, index),
			&Opcode::SetLocal(index) => Self::validate_set_local(context, index),
			&Opcode::TeeLocal(index) => Self::validate_tee_local(context, index),
			&Opcode::GetGlobal(index) => Self::validate_get_global(context, index),
			&Opcode::SetGlobal(index) => Self::validate_set_global(context, index),

			&Opcode::I32Load(align, _) => Self::validate_load(context, align, 4, ValueType::I32.into()),
			&Opcode::I64Load(align, _) => Self::validate_load(context, align, 8, ValueType::I64.into()),
			&Opcode::F32Load(align, _) => Self::validate_load(context, align, 4, ValueType::F32.into()),
			&Opcode::F64Load(align, _) => Self::validate_load(context, align, 8, ValueType::F64.into()),
			&Opcode::I32Load8S(align, _) => Self::validate_load(context, align, 1, ValueType::I32.into()),
			&Opcode::I32Load8U(align, _) => Self::validate_load(context, align, 1, ValueType::I32.into()),
			&Opcode::I32Load16S(align, _) => Self::validate_load(context, align, 2, ValueType::I32.into()),
			&Opcode::I32Load16U(align, _) => Self::validate_load(context, align, 2, ValueType::I32.into()),
			&Opcode::I64Load8S(align, _) => Self::validate_load(context, align, 1, ValueType::I64.into()),
			&Opcode::I64Load8U(align, _) => Self::validate_load(context, align, 1, ValueType::I64.into()),
			&Opcode::I64Load16S(align, _) => Self::validate_load(context, align, 2, ValueType::I64.into()),
			&Opcode::I64Load16U(align, _) => Self::validate_load(context, align, 2, ValueType::I64.into()),
			&Opcode::I64Load32S(align, _) => Self::validate_load(context, align, 4, ValueType::I64.into()),
			&Opcode::I64Load32U(align, _) => Self::validate_load(context, align, 4, ValueType::I64.into()),

			&Opcode::I32Store(align, _) => Self::validate_store(context, align, 4, ValueType::I32.into()),
			&Opcode::I64Store(align, _) => Self::validate_store(context, align, 8, ValueType::I64.into()),
			&Opcode::F32Store(align, _) => Self::validate_store(context, align, 4, ValueType::F32.into()),
			&Opcode::F64Store(align, _) => Self::validate_store(context, align, 8, ValueType::F64.into()),
			&Opcode::I32Store8(align, _) => Self::validate_store(context, align, 1, ValueType::I32.into()),
			&Opcode::I32Store16(align, _) => Self::validate_store(context, align, 2, ValueType::I32.into()),
			&Opcode::I64Store8(align, _) => Self::validate_store(context, align, 1, ValueType::I64.into()),
			&Opcode::I64Store16(align, _) => Self::validate_store(context, align, 2, ValueType::I64.into()),
			&Opcode::I64Store32(align, _) => Self::validate_store(context, align, 4, ValueType::I64.into()),

			&Opcode::CurrentMemory(_) => Self::validate_current_memory(context),
			&Opcode::GrowMemory(_) => Self::validate_grow_memory(context),

			&Opcode::I32Const(_) => Self::validate_const(context, ValueType::I32.into()),
			&Opcode::I64Const(_) => Self::validate_const(context, ValueType::I64.into()),
			&Opcode::F32Const(_) => Self::validate_const(context, ValueType::F32.into()),
			&Opcode::F64Const(_) => Self::validate_const(context, ValueType::F64.into()),

			&Opcode::I32Eqz => Self::validate_testop(context, ValueType::I32.into()),
			&Opcode::I32Eq => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32Ne => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32LtS => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32LtU => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32GtS => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32GtU => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32LeS => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32LeU => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32GeS => Self::validate_relop(context, ValueType::I32.into()),
			&Opcode::I32GeU => Self::validate_relop(context, ValueType::I32.into()),

			&Opcode::I64Eqz => Self::validate_testop(context, ValueType::I64.into()),
			&Opcode::I64Eq => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64Ne => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64LtS => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64LtU => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64GtS => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64GtU => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64LeS => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64LeU => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64GeS => Self::validate_relop(context, ValueType::I64.into()),
			&Opcode::I64GeU => Self::validate_relop(context, ValueType::I64.into()),

			&Opcode::F32Eq => Self::validate_relop(context, ValueType::F32.into()),
			&Opcode::F32Ne => Self::validate_relop(context, ValueType::F32.into()),
			&Opcode::F32Lt => Self::validate_relop(context, ValueType::F32.into()),
			&Opcode::F32Gt => Self::validate_relop(context, ValueType::F32.into()),
			&Opcode::F32Le => Self::validate_relop(context, ValueType::F32.into()),
			&Opcode::F32Ge => Self::validate_relop(context, ValueType::F32.into()),

			&Opcode::F64Eq => Self::validate_relop(context, ValueType::F64.into()),
			&Opcode::F64Ne => Self::validate_relop(context, ValueType::F64.into()),
			&Opcode::F64Lt => Self::validate_relop(context, ValueType::F64.into()),
			&Opcode::F64Gt => Self::validate_relop(context, ValueType::F64.into()),
			&Opcode::F64Le => Self::validate_relop(context, ValueType::F64.into()),
			&Opcode::F64Ge => Self::validate_relop(context, ValueType::F64.into()),

			&Opcode::I32Clz => Self::validate_unop(context, ValueType::I32.into()),
			&Opcode::I32Ctz => Self::validate_unop(context, ValueType::I32.into()),
			&Opcode::I32Popcnt => Self::validate_unop(context, ValueType::I32.into()),
			&Opcode::I32Add => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32Sub => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32Mul => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32DivS => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32DivU => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32RemS => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32RemU => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32And => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32Or => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32Xor => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32Shl => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32ShrS => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32ShrU => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32Rotl => Self::validate_binop(context, ValueType::I32.into()),
			&Opcode::I32Rotr => Self::validate_binop(context, ValueType::I32.into()),

			&Opcode::I64Clz => Self::validate_unop(context, ValueType::I64.into()),
			&Opcode::I64Ctz => Self::validate_unop(context, ValueType::I64.into()),
			&Opcode::I64Popcnt => Self::validate_unop(context, ValueType::I64.into()),
			&Opcode::I64Add => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64Sub => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64Mul => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64DivS => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64DivU => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64RemS => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64RemU => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64And => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64Or => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64Xor => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64Shl => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64ShrS => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64ShrU => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64Rotl => Self::validate_binop(context, ValueType::I64.into()),
			&Opcode::I64Rotr => Self::validate_binop(context, ValueType::I64.into()),

			&Opcode::F32Abs => Self::validate_unop(context, ValueType::F32.into()),
			&Opcode::F32Neg => Self::validate_unop(context, ValueType::F32.into()),
			&Opcode::F32Ceil => Self::validate_unop(context, ValueType::F32.into()),
			&Opcode::F32Floor => Self::validate_unop(context, ValueType::F32.into()),
			&Opcode::F32Trunc => Self::validate_unop(context, ValueType::F32.into()),
			&Opcode::F32Nearest => Self::validate_unop(context, ValueType::F32.into()),
			&Opcode::F32Sqrt => Self::validate_unop(context, ValueType::F32.into()),
			&Opcode::F32Add => Self::validate_binop(context, ValueType::F32.into()),
			&Opcode::F32Sub => Self::validate_binop(context, ValueType::F32.into()),
			&Opcode::F32Mul => Self::validate_binop(context, ValueType::F32.into()),
			&Opcode::F32Div => Self::validate_binop(context, ValueType::F32.into()),
			&Opcode::F32Min => Self::validate_binop(context, ValueType::F32.into()),
			&Opcode::F32Max => Self::validate_binop(context, ValueType::F32.into()),
			&Opcode::F32Copysign => Self::validate_binop(context, ValueType::F32.into()),

			&Opcode::F64Abs => Self::validate_unop(context, ValueType::F64.into()),
			&Opcode::F64Neg => Self::validate_unop(context, ValueType::F64.into()),
			&Opcode::F64Ceil => Self::validate_unop(context, ValueType::F64.into()),
			&Opcode::F64Floor => Self::validate_unop(context, ValueType::F64.into()),
			&Opcode::F64Trunc => Self::validate_unop(context, ValueType::F64.into()),
			&Opcode::F64Nearest => Self::validate_unop(context, ValueType::F64.into()),
			&Opcode::F64Sqrt => Self::validate_unop(context, ValueType::F64.into()),
			&Opcode::F64Add => Self::validate_binop(context, ValueType::F64.into()),
			&Opcode::F64Sub => Self::validate_binop(context, ValueType::F64.into()),
			&Opcode::F64Mul => Self::validate_binop(context, ValueType::F64.into()),
			&Opcode::F64Div => Self::validate_binop(context, ValueType::F64.into()),
			&Opcode::F64Min => Self::validate_binop(context, ValueType::F64.into()),
			&Opcode::F64Max => Self::validate_binop(context, ValueType::F64.into()),
			&Opcode::F64Copysign => Self::validate_binop(context, ValueType::F64.into()),

			&Opcode::I32WarpI64 => Self::validate_cvtop(context, ValueType::I64.into(), ValueType::I32.into()),
			&Opcode::I32TruncSF32 => Self::validate_cvtop(context, ValueType::F32.into(), ValueType::I32.into()),
			&Opcode::I32TruncUF32 => Self::validate_cvtop(context, ValueType::F32.into(), ValueType::I32.into()),
			&Opcode::I32TruncSF64 => Self::validate_cvtop(context, ValueType::F64.into(), ValueType::I32.into()),
			&Opcode::I32TruncUF64 => Self::validate_cvtop(context, ValueType::F64.into(), ValueType::I32.into()),
			&Opcode::I64ExtendSI32 => Self::validate_cvtop(context, ValueType::I32.into(), ValueType::I64.into()),
			&Opcode::I64ExtendUI32 => Self::validate_cvtop(context, ValueType::I32.into(), ValueType::I64.into()),
			&Opcode::I64TruncSF32 => Self::validate_cvtop(context, ValueType::F32.into(), ValueType::I64.into()),
			&Opcode::I64TruncUF32 => Self::validate_cvtop(context, ValueType::F32.into(), ValueType::I64.into()),
			&Opcode::I64TruncSF64 => Self::validate_cvtop(context, ValueType::F64.into(), ValueType::I64.into()),
			&Opcode::I64TruncUF64 => Self::validate_cvtop(context, ValueType::F64.into(), ValueType::I64.into()),
			&Opcode::F32ConvertSI32 => Self::validate_cvtop(context, ValueType::I32.into(), ValueType::F32.into()),
			&Opcode::F32ConvertUI32 => Self::validate_cvtop(context, ValueType::I32.into(), ValueType::F32.into()),
			&Opcode::F32ConvertSI64 => Self::validate_cvtop(context, ValueType::I64.into(), ValueType::F32.into()),
			&Opcode::F32ConvertUI64 => Self::validate_cvtop(context, ValueType::I64.into(), ValueType::F32.into()),
			&Opcode::F32DemoteF64 => Self::validate_cvtop(context, ValueType::F64.into(), ValueType::F32.into()),
			&Opcode::F64ConvertSI32 => Self::validate_cvtop(context, ValueType::I32.into(), ValueType::F64.into()),
			&Opcode::F64ConvertUI32 => Self::validate_cvtop(context, ValueType::I32.into(), ValueType::F64.into()),
			&Opcode::F64ConvertSI64 => Self::validate_cvtop(context, ValueType::I64.into(), ValueType::F64.into()),
			&Opcode::F64ConvertUI64 => Self::validate_cvtop(context, ValueType::I64.into(), ValueType::F64.into()),
			&Opcode::F64PromoteF32 => Self::validate_cvtop(context, ValueType::F32.into(), ValueType::F64.into()),

			&Opcode::I32ReinterpretF32 => Self::validate_cvtop(context, ValueType::F32.into(), ValueType::I32.into()),
			&Opcode::I64ReinterpretF64 => Self::validate_cvtop(context, ValueType::F64.into(), ValueType::I64.into()),
			&Opcode::F32ReinterpretI32 => Self::validate_cvtop(context, ValueType::I32.into(), ValueType::F32.into()),
			&Opcode::F64ReinterpretI64 => Self::validate_cvtop(context, ValueType::I64.into(), ValueType::F64.into()),
		}
	}
...
impl<E> Validator<E> for DefaultValidator<E> where E: UserError {}
